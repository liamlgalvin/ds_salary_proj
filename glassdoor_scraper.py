# -*- coding: utf-8 -*-
"""
Created on Thu Jun 25 15:34:11 2020

@author: arapfaik/scraping-glassdoor-selenium
modificado para glassdoor.es
"""
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
   ...
   # url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword="' + keyword + '"&locT=C&locId=1147401&locKeyword=San%20Francisco,%20CA&jobType=all&fromAge=-1&minSalary=0&includeNoSalaryJobs=true&radius=100&cityId=-1&minRating=0.0&industryId=-1&sgocId=-1&seniorityType=all&companyId=-1&employerSizes=0&applicationType=0&remoteWorkType=0'
    url = 'https://www.glassdoor.es/Empleo/empleos.htm?sc.generalKeyword="' + keyword + '"&sc.locationSeoString=estados+unidos&locId=1&locT=N'
    driver.get(url)
    jobs = []
